...
urlpatterns = [
    ...
    path('api/meal-plan/add/', user_views.meal_plan_add, name='api_meal_plan_add'),
    path('thuc-don/xoa/<int:plan_id>/', user_views.meal_plan_delete, name='meal_plan_delete'),
    path('thuc-don/theo-doi-ngay/', user_views.meal_plan_toggle_follow, name='meal_plan_toggle_follow'),
    ...
    path('mon-an/<int:food_id>/', user_views.food_detail, name='food_detail'),
    path('mon-an/tim-kiem/', user_views.foods_search, name='foods_search'),
    path('api/foods/search/', user_views.foods_search, name='api_foods_search'),
    path('api/recommendation/feedback/', user_views.recommendation_feedback, name='recommendation_feedback'),
