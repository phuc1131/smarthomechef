/**
 * Responsive Navigation & Layout Management for Admin Panel
...
document.addEventListener('DOMContentLoaded', function () {
   ...
   */
  const scrollables = document.querySelectorAll('.table-responsive');
  ...
  console.log('Responsive navigation initialized (Admin Panel)');
});
